...
Route::get('/twoD-play', [App\Http\Controllers\User\WelcomeController::class, 'twoDPlay']);
Route::get('/twoD-confirm', [App\Http\Controllers\User\WelcomeController::class, 'twoDConfirm']);
Route::get('/twoD-winner', [App\Http\Controllers\User\WelcomeController::class, 'twoDWinner']);
Route::get('/twoD-history', [App\Http\Controllers\User\WelcomeController::class, 'twoDHistory']);
...
Route::get('/topUp-confirm', [App\Http\Controllers\User\WelcomeController::class, 'topUpConfirm']);
Route::get('/withdraw', [App\Http\Controllers\User\WelcomeController::class, 'withdraw']);
Route::get('/withdraw-confirm', [App\Http\Controllers\User\WelcomeController::class, 'withdrawConfirm']);

Route::get('/contact', [App\Http\Controllers\User\WelcomeController::class, 'contact']);
Route::get('/changepw', [App\Http\Controllers\User\WelcomeController::class, 'changePwd']);
Route::get('/banks', [App\Http\Controllers\User\WelcomeController::class, 'banks']);
